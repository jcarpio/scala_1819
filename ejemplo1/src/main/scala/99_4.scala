import P03.{nthBuiltin, nthRecursive}
...
object P04 {
  ...
  def main(args: Array[String]){
    print( lengthBuiltin(List(1, 1, 2, 3, 5, 8)) );
    print("\n");
    print( lengthRecursive(List(1, 1, 2, 3, 5, 8)) );
    print("\n");
    print( lengthFunctional(List(1, 1, 2, 3, 5, 8)) );
    print("\n");
    print( lengthTailRecursive(List(1, 1, 2, 3, 5, 8)) );
  }
}